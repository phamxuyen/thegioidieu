...
class ControllerModuleEcslideshow extends Controller {
	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['link_to_module'] = $this->url->link('module/ecslideshow', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
			$data['link_to_banner'] = $this->url->link('module/ecslideshow/banner', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		$data['help_easing'] = $this->language->get('help_easing');
		...
		$data['help_navigation_hover'] = $this->language->get('help_navigation_hover');
		$data['entry_pagination'] = $this->language->get('entry_pagination');
		$data['entry_play_pause'] = $this->language->get('entry_play_pause');
		$data['help_play_pause'] = $this->language->get('help_play_pause');
		...
		$data['help_trans_period'] = $this->language->get('help_trans_period');
		$data['entry_async_loading'] = $this->language->get('entry_async_loading');
		$data['help_async_loading'] = $this->language->get('help_async_loading');
		...
		$data['tab_effect'] = $this->language->get('tab_effect');
	...
	protected function getForm(){
		...
		$data['help_caption_alignment'] = $this->language->get('help_caption_alignment');
		$data['entry_image_alignment'] = $this->language->get('entry_image_alignment');
		$data['help_image_alignment'] = $this->language->get('help_image_alignment');
		$data['entry_easing'] = $this->language->get('entry_easing');
		$data['entry_effect'] = $this->language->get('entry_effect');
		$data['help_effect'] = $this->language->get('help_effect');
		$data['entry_show_caption'] = $this->language->get('entry_show_caption');
        ...
        if (isset($this->request->post['banner_image'])) {
            foreach ($this->request->post['banner_image'] as $banner_image_id => $banner_image) {
                foreach ($banner_image['banner_image_description'] as $language_id => $banner_image_description) {
                    if (strlen(utf8_decode($banner_image_description['title'])) > 100) {
