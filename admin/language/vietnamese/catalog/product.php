...
$_['entry_isbn']             = 'ISBN:<br/><span class="help">Mã sách theo chuẩn quốc tế</span>';
$_['entry_mpn']              = 'MPN:<br/><span class="help">Part Number theo nhà sản xuất</span>';
...
// Help
$_['help_keyword']           = 'Từ khóa phải là duy nhất. Không sử dụng khoảng trắng cho từ khóa.';
$_['help_sku']               = 'Stock Keeping Unit';
$_['help_upc']               = 'Universal Product Code';
$_['help_ean']               = 'European Article Number';
$_['help_jan']               = 'Japanese Article Number';
$_['help_isbn']              = 'Mã sách theo chuẩn quốc tế';
$_['help_mpn']               = 'Manufacturer Part Number';
$_['help_manufacturer']      = '(Autocomplete)';
$_['help_minimum']           = 'Số lượng ít nhất khi đặt hàng';
$_['help_stock_status']      = 'Tình trạng hiện ra khi một sản phẩm hết hàng';
$_['help_points']            = 'Số điểm cần thiết để mua mặt hàng này. Nếu bạn không \'muốn sản phẩm này được mua với điểm để là 0.';
