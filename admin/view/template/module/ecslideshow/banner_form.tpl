            ...
            <ul class="nav nav-tabs" id="language-<?php echo $image_row; ?>">
              ...
              <?php foreach ($languages as $tmp_language) { ?>
                <div class="tab-pane" id="tab-language-<?php echo $image_row; ?>-<?php echo $tmp_language['language_id']; ?>">
                  <div class="form-group">
                      <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $language->get( 'help_title' ); ?>"><?php echo $language->get( 'entry_title' ); ?></span></label>
              ...
              <div class="row">
                <div id="images" class="col-sm-10 table">
                  ...
                  <input type="hidden" name="banner_image[<?php echo $image_row; ?>][image]" value="<?php echo $banner_image['image'];?>" id="input-image-<?php echo $image_row; ?>" />
                   ...
                   <div class="form-group">
                    <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $language->get("help_caption_alignment");?>"><?php echo $language->get("entry_caption_alignment");?></span></label>
                   ...
                   <div class="form-group">
                    <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $language->get("help_image_alignment");?>"><?php echo $language->get("entry_image_alignment");?></span></label>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                    <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $language->get("help_effect");?>"><?php echo $language->get("entry_effect");?></span></label>
...
function addImage() {
  var html = '<div id="tab-module-'+token+'" class="tab-pane vtabs-content">';
    ...
    html +='          <label class="col-sm-2 control-label" for="input-title-'+token+'<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title data-original-title="<?php echo $help_title;?>"><?php echo $entry_title;?></span></label>';
    ...
    html +='                  <div class="col-sm-8"><input type="text" id="product_autocomplete_'+token+'" name="products" value="" size="40" placeholder="<?php echo $text_input_product_name;?>"/> <?php echo $entry_product_id;?><input size="10" type="text" id="banner_image_'+token+'_product" name="banner_image['+token+'][product_id]" value="" /></div>';
    html +='                </div>';
    html +='                <div class="form-group">';
    ...
    html +='               </div>';
    html +='               <div class="form-group">';
    html +='                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $help_caption_alignment;?>"><?php echo $entry_caption_alignment;?></span></label>';
    ...
    html +='               </div>';
    html +='               <div class="form-group">';
    html +='                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $help_image_alignment;?>"><?php echo $entry_image_alignment;?></span></label>';
    ...
    html +='               </div>';
    html +='                <div class="form-group">';
    html +='                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $entry_effect;?>"><?php echo $help_effect;?></span></label>';
