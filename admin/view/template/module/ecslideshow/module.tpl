    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ecslideshow" class="form-horizontal">
		...
		<ul class="nav nav-tabs">
            ...
            <li><a href="#tab-effect" data-toggle="tab"><?php echo $tab_effect; ?></a></li>
        </ul>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_async_loading; ?>"><?php echo $entry_async_loading; ?></span></label>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8"><select class="form-control" name="banner_id">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $help_easing; ?>"><?php echo $entry_easing; ?></span></label>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8"><select class="form-control" name="fx[]">
                <?php 
                 if($effects){
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $help_hover; ?>"><?php echo $entry_hover; ?></span></label>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $help_navigation; ?>"><?php echo $entry_navigation; ?></span></label>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $help_navigation_hover; ?>"><?php echo $entry_navigation_hover; ?></span></label>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $help_play_pause; ?>"><?php echo $entry_play_pause; ?></span></label>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $help_time; ?>"><?php echo $entry_time; ?></span></label>
            <div class="col-sm-8"><input class="form-control" type="text" name="time" value="<?php echo $time; ?>" size="10" /></div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" title data-original-title="<?php echo $help_trans_period; ?>"><?php echo $entry_trans_period; ?></span></label>
