...
class ModelBossblogArticle extends Model {
	...
	public function getArticleLayoutId($blog_article_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "blog_article_layout WHERE blog_article_id = '" . (int)$blog_article_id . "' AND store_id = '" . (int)$this->config->get('config_store_id') . "'");
