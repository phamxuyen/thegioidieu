...
<div class="container">
  <div class="row">
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal return_form">
        <fieldset>
        ...
        <div class="buttons clearfix">
          ...
          <div class="pull-right">
            <input type="submit" value="<?php echo $button_submit; ?>" class="btn btn-shopping" />
          </div>
        </div>
        <?php } ?>
      </form>
