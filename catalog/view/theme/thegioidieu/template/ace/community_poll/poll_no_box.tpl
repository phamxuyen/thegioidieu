<!--Poll module start--> 
<h3><?php echo $text_poll;?></h3>
 <div class="page-item margin-bottom-20" id="ace-poll<?php echo $id;?>">
 <?php if($poll_data){?>
 ...
 <div class="front-skills">
  ...
  <?php if($total_votes>0){?> 
   <div class="buttons">
       <div class="right">
       <a href="<?php echo $poll_results;?>"  class="vsmodalbox btn btn-xs <?php echo $this->ace->get('btn_primary');?>" data-type="html" data-title="<?php echo $poll_data['question'];?>"><?php echo $text_poll_results;?></a>
       </div>
   </div>
   <?php }?>
 ...
 <div class="radio-list" id="vote-poll<?php echo $id;?>">
   ...
   <div class="buttons">
       <div class="left">
		<a id="button-vote<?php echo $id;?>" class="btn btn-xs <?php echo $this->ace->get('btn_primary');?>"><span><?php echo $text_vote;?></span></a>
		</div>
  <?php if($total_votes>0){?> 
       <div class="right"><a href="<?php echo $poll_results;?>"  class="vsmodalbox btn btn-xs <?php echo $this->ace->get('btn_primary');?>" data-type="html" data-title="<?php echo $poll_data['question'];?>"><?php echo $text_poll_results;?></a>
      </div>
   <?php }?>
	</div>
