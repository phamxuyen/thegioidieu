<form class="form-horizontal">
  ...
  <div class="form-group required" style="display:none;">
    ...
    <div>
      <input type="text" name="postcode" value="7000" placeholder="<?php echo $entry_postcode; ?>" id="input-shipping-postcode" class="form-control" />
    </div>
  </div>
  <div class="form-group required">
  ...
  <div class="buttons">
    <div class="pull-left">
      <input type="button" value="<?php echo $button_continue; ?>" id="button-guest-shipping" data-loading-text="<?php echo $text_loading; ?>" class="btn" />
    </div>
  </div>
</form>
