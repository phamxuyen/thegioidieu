  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required" style="display:none;">
        ...
        <input type="text" name="postcode" value="7000" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" class="form-control" />
      </div>
      <div class="form-group required">
...
<div class="checkbox clearfix">
	...
	<br/>
	<input type="button" value="<?php echo $button_continue; ?>" id="button-register" data-loading-text="<?php echo $text_loading; ?>" class="btn" />
