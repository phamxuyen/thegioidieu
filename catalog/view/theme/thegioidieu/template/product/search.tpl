...
<div class="container">
  <div class="row">
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <h2 style="margin-top: 20px;"><?php echo $text_search; ?></h2>
	  <hr />
      <?php if ($products) { ?>
      ...
      <label class="control-label" for="input-search"><?php echo $heading_title; ?></label>
	   <div class="row">
        <div class="col-sm-4">
      <input type="text" name="search" value="<?php echo $search; ?>" placeholder="<?php echo $text_keyword; ?>" id="input-search" class="form-control" style="width: 100%;" />
	  </div>
	  <div class="col-sm-4">
