	...
	<div class="newletter-content">
		<div id="frm_subscribe">
			<form name="subscribe" id="subscribe"   >
				<table>
				   <tr>
					 <td><div class="boss-newletter"><input class="form-control" size="50" class="input-new" type="text" placeholder="<?php echo $text_email; ?>" name="subscribe_email" id="subscribe_email"> <a class="btn_newletter" onclick="email_subscribe()"><i class="fa fa-angle-right"></i></a></div></td>
					</tr>
