...
DROP TABLE IF EXISTS `oc_ace_poll`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_ace_poll` (
  `poll_id` int(11) NOT NULL AUTO_INCREMENT,
  `color` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT 'blue-sky',
  `date_added` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`poll_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `oc_ace_poll_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_ace_poll_description` (
  ...
  `answer_6` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`poll_id`,`language_id`),
  KEY `question` (`question`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `oc_ace_poll_reactions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_ace_poll_reactions` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `oc_ace_poll_to_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_ace_poll_to_store` (
  `poll_id` int(11) NOT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `oc_ecbanner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_ecbanner` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `oc_ecbanner_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_ecbanner_image` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `oc_ecbanner_image_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc_ecbanner_image_description` (
...
CREATE TABLE `oc_product_image` (
  ...
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2971 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=8715 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
